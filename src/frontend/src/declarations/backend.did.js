...
export const idlFactory = ({ IDL }) => {
  ...
  return IDL.Service({
    ...
    'addSftEntry' : IDL.Func([IDL.Text, IDL.Text, IDL.Text, IDL.Text, IDL.Float64, IDL.Float64, IDL.Float64, IDL.Float64, IDL.Float64, IDL.Float64, IDL.Text], [IDL.Text], []),
    'updateSftEntry' : IDL.Func([IDL.Text, IDL.Text, IDL.Text, IDL.Text, IDL.Text, IDL.Float64, IDL.Float64, IDL.Float64, IDL.Float64, IDL.Float64, IDL.Float64, IDL.Text, IDL.Text], [], []),
    'deleteSftEntries' : IDL.Func([IDL.Vec(IDL.Text), IDL.Text], [], []),
    'listSftEntries' : IDL.Func([], [IDL.Vec(IDL.Record({ 'id': IDL.Text, 'contractorId': IDL.Text, 'projectId': IDL.Text, 'billNo': IDL.Text, 'slabNo': IDL.Text, 'footings': IDL.Float64, 'rw': IDL.Float64, 'columns': IDL.Float64, 'beams': IDL.Float64, 'slab': IDL.Float64, 'oht': IDL.Float64, 'totalSft': IDL.Float64, 'remarks': IDL.Text }))], ['query']),
