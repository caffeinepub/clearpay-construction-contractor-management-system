...
export default function ChartZoomModal({ open, onClose, title, children, onExportCSV }: ChartZoomModalProps) {
  return (
      ...
      <DialogPortal>
        ...
        >
          <DialogHeader className="sticky top-0 z-10 bg-white border-b border-[#E0E0E0] px-6 py-4 flex flex-row items-center justify-between space-y-0">
            <DialogTitle className="text-2xl font-bold text-[#555555]">{title}</DialogTitle>
          ...
          <div className="overflow-auto" style={{ height: 'calc(770px - 73px)', maxHeight: 'calc(90vh - 73px)' }}>
            <div className="p-6 flex items-center justify-center">
              <div style={{ width: '100%', maxWidth: '1500px', height: '650px' }}>
                {children}
              </div>
            </div>
          </div>
